...
kernel void reduction(global float* tmp_speed_0,
                    global float* tmp_speed_1,
                    global float* tmp_speed_2,
                    global float* tmp_speed_3,
                    global float* tmp_speed_4,
                      ...
                      local float *local_sums)
{
  ...
  float local_density_0 = 0.f;

        local_density_0 += tmp_speed_0[global_id]
                      + tmp_speed_1[global_id]
                      + tmp_speed_2[global_id]
                      + tmp_speed_3[global_id]
                      + tmp_speed_4[global_id]
                      + tmp_speed_5[global_id]
                      + tmp_speed_6[global_id]
                      + tmp_speed_7[global_id]
                      + tmp_speed_8[global_id];
              
        float u_x_0 = (tmp_speed_1[global_id] + tmp_speed_5[global_id] + tmp_speed_8[global_id] - (tmp_speed_3[global_id] + tmp_speed_6[global_id] + tmp_speed_7[global_id])) / local_density_0;
        float u_y_0 = (tmp_speed_2[global_id] + tmp_speed_5[global_id] + tmp_speed_6[global_id] - (tmp_speed_4[global_id] + tmp_speed_7[global_id] + tmp_speed_8[global_id])) / local_density_0;
        
        float sum_0 = (obstacles[global_id]) ? (0.f) : (sqrt((u_x_0 * u_x_0) + (u_y_0 * u_y_0)));

        float local_density_1 = 0.f;

        local_density_1 += tmp_speed_0[global_id+global_size]
                      + tmp_speed_1[global_id+global_size]
                      + tmp_speed_2[global_id+global_size]
                      + tmp_speed_3[global_id+global_size]
                      + tmp_speed_4[global_id+global_size]
                      + tmp_speed_5[global_id+global_size]
                      + tmp_speed_6[global_id+global_size]
                      + tmp_speed_7[global_id+global_size]
                      + tmp_speed_8[global_id+global_size];

        float u_x_1 = (tmp_speed_1[global_id+global_size] + tmp_speed_5[global_id+global_size] + tmp_speed_8[global_id+global_size] - (tmp_speed_3[global_id+global_size] + tmp_speed_6[global_id+global_size] + tmp_speed_7[global_id+global_size])) / local_density_1;
        float u_y_1 = (tmp_speed_2[global_id+global_size] + tmp_speed_5[global_id+global_size] + tmp_speed_6[global_id+global_size] - (tmp_speed_4[global_id+global_size] + tmp_speed_7[global_id+global_size] + tmp_speed_8[global_id+global_size])) / local_density_1;
        
        float sum_1 = (obstacles[global_id+global_size]) ? (0.f) : (sqrt((u_x_1 * u_x_1) + (u_y_1 * u_y_1)));


  local_sums[local_id] = sum_0 + sum_1;
