...
{  
  ...
  tmp_cells[ii + jj*nx].speeds[6] = cells[x_w + y_n*nx].speeds[8];
    ...
    local_density += cells[ii + jj*nx].speeds[0] + cells[x_w + jj*nx].speeds[1] + cells[ii + y_s*nx].speeds[2] + cells[x_e + jj*nx].speeds[3] + cells[ii + y_n*nx].speeds[4] + cells[x_w + y_s*nx].speeds[5] + cells[x_e + y_s*nx].speeds[6] + cells[x_e + y_n*nx].speeds[7] + cells[x_w + y_n*nx].speeds[8];

        /* compute x velocity component */
        float u_x = (cells[x_w + jj*nx].speeds[1] + cells[x_w + y_s*nx].speeds[5] + cells[x_w + y_n*nx].speeds[8] - (cells[x_e + jj*nx].speeds[3] + cells[x_e + y_s*nx].speeds[6] + cells[x_e + y_n*nx].speeds[7])) / local_density;
        /* compute y velocity component */
        float u_y = (cells[ii + y_s*nx].speeds[2] + cells[x_w + y_s*nx].speeds[5] + cells[x_e + y_s*nx].speeds[6] - (cells[ii + y_n*nx].speeds[4] + cells[x_e + y_n*nx].speeds[7] + cells[x_w + y_n*nx].speeds[8])) / local_density;
        ...
        tmp_cells[ii + jj * nx].speeds[0] = cells[ii + jj*nx].speeds[0] + omega * (d_equ[0] - cells[ii + jj*nx].speeds[0]);
        tmp_cells[ii + jj * nx].speeds[1] = cells[x_w + jj*nx].speeds[1] + omega * (d_equ[1] - cells[x_w + jj*nx].speeds[1]);
        tmp_cells[ii + jj * nx].speeds[2] = cells[ii + y_s*nx].speeds[2] + omega * (d_equ[2] - cells[ii + y_s*nx].speeds[2]);
        tmp_cells[ii + jj * nx].speeds[3] = cells[x_e + jj*nx].speeds[3] + omega * (d_equ[3] - cells[x_e + jj*nx].speeds[3]);
        tmp_cells[ii + jj * nx].speeds[4] = cells[ii + y_n*nx].speeds[4] + omega * (d_equ[4] - cells[ii + y_n*nx].speeds[4]);
        tmp_cells[ii + jj * nx].speeds[5] = cells[x_w + y_s*nx].speeds[5] + omega * (d_equ[5] - cells[x_w + y_s*nx].speeds[5]);
        tmp_cells[ii + jj * nx].speeds[6] = cells[x_e + y_s*nx].speeds[6] + omega * (d_equ[6] - cells[x_e + y_s*nx].speeds[6]);
        tmp_cells[ii + jj * nx].speeds[7] = cells[x_e + y_n*nx].speeds[7] + omega * (d_equ[7] - cells[x_e + y_n*nx].speeds[7]);
        tmp_cells[ii + jj * nx].speeds[8] = cells[x_w + y_n*nx].speeds[8] + omega * (d_equ[8] - cells[x_w + y_n*nx].speeds[8]);
  }
}

kernel void av_velocity_kernel(global t_speed *tmp_cells,
                              global int *obstacles,
